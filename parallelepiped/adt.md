...
* **float ab_line** - Расстояние между точками _A_ и _B_ (=> и между _C_ и _D_ и аналогично для верхней грани соответственно). Измеряется в мм. По умолчанию значение равно 0;
* **float bc_line** - Расстояние между точками _B_ и _С_ (аналогично для **ab**). По умолчанию значение равно 0 мм.;
* **float side_line** - Длина бокового ребра. По умолчанию значение равно 0 мм.;
* **float bad_angle** - Угол _BAD_ основания _ABCD_. По умолчанию равен 90 гр.;
* **float a1ad_angle** - Угол _A1AD_. Формирует угол наклона призмы в одно направление. По умолчанию равен 90 гр.;
* **float a1ab_angle** - Угол _A1AB_. Подобно **a1ad_angle** формирует угол в другое направление. По умолчанию равен 90 гр.;
## Конструкторы
* ### Конструктор 1
  * Вход: -
...
* ### **getLineSide**
  * Вход: -
  * Выход: **float side_line**
* ### **getAngleBAD**
  * Вход: -
  * Выход: **float bad_angle**
* ### **getAnlgeA1AD**
  * Вход: -
  * Выход: **float a1ad_angle**
* ### **getAngleA1AB**
  * Вход: -
  * Выход: **float a1ab_angle**
----
* ### **getType**
  * Вход: -
...
* ### **setLineAB**
  * Вход: **pab_line**
  * Предусловие: **pab_line** >= 0
  * Процесс: **ab_line = pab_line**
  * Выход: **true**, если предусловие было соблюдено
* ### **setLineBC**
  * Вход: **pbc_line**
  * Предусловие: **pbc_line** >= 0
  * Процесс: **bc_line = pbc_line**
  * Выход: **true**, если предусловие было соблюдено
* ### **setLineSide**
  * Вход: **pside_line**
